...
#define __PYX_HAVE__simplestart__ui__autocomplete
#define __PYX_HAVE_API__simplestart__ui__autocomplete
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "simplestart/ui/autocomplete.py",
};
...
/* Module declarations from "simplestart.ui.autocomplete" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "simplestart.ui.autocomplete"
extern int __pyx_module_is_main_simplestart__ui__autocomplete;
int __pyx_module_is_main_simplestart__ui__autocomplete = 0;

/* Implementation of "simplestart.ui.autocomplete" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_11simplestart_2ui_12autocomplete_autocomplete(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_autocomplete_data, PyObject *__pyx_v_onselect); /* proto */
...
#define __pyx_kp_u_simplestart_ui_autocomplete_py __pyx_string_tab[2]
#define __pyx_kp_u_template_div_class_demo_autocom __pyx_string_tab[3]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[4]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[5]
#define __pyx_n_u_autocomplete __pyx_string_tab[6]
#define __pyx_n_u_autocomplete_data __pyx_string_tab[7]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[8]
#define __pyx_n_u_core __pyx_string_tab[9]
#define __pyx_n_u_data __pyx_string_tab[10]
#define __pyx_n_u_func __pyx_string_tab[11]
#define __pyx_n_u_handlers __pyx_string_tab[12]
#define __pyx_n_u_is_coroutine __pyx_string_tab[13]
#define __pyx_n_u_items __pyx_string_tab[14]
#define __pyx_n_u_loadvue __pyx_string_tab[15]
...
#define __pyx_n_u_onSelect __pyx_string_tab[19]
#define __pyx_n_u_onselect __pyx_string_tab[20]
...
#define __pyx_n_u_simplestart_ui_autocomplete __pyx_string_tab[25]
...
#define __pyx_n_u_vue_template_basic __pyx_string_tab[29]
#define __pyx_kp_b_iso88591_A_q_M_q_7_Q __pyx_string_tab[30]
...
/* "simplestart/ui/autocomplete.py":63
 * 
 * 
 * def autocomplete(autocomplete_data, onselect=None):             # <<<<<<<<<<<<<<
 *     """
 * 
*/

/* Python wrapper */
static PyObject *__pyx_pw_11simplestart_2ui_12autocomplete_1autocomplete(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_11simplestart_2ui_12autocomplete_autocomplete, "\n    \345\210\233\345\273\272\344\270\200\344\270\252\350\207\252\345\212\250\350\241\245\345\205\250\350\276\223\345\205\245\346\241\206\347\273\204\344\273\266\n    \n    \345\217\202\346\225\260:\n        autocomplete_data: \345\214\205\345\220\253items\345\210\227\350\241\250\347\232\204\346\225\260\346\215\256\345\257\271\350\261\241\n        onselect: \351\200\211\344\270\255\344\272\213\344\273\266\345\244\204\347\220\206\345\207\275\346\225\260\n    \n    \350\277\224\345\233\236:\n        \345\210\233\345\273\272\347\232\204autocomplete\347\273\204\344\273\266\345\256\236\344\276\213\n    ");
static PyMethodDef __pyx_mdef_11simplestart_2ui_12autocomplete_1autocomplete = {"autocomplete", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11simplestart_2ui_12autocomplete_1autocomplete, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_11simplestart_2ui_12autocomplete_autocomplete};
static PyObject *__pyx_pw_11simplestart_2ui_12autocomplete_1autocomplete(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_autocomplete_data = 0;
  PyObject *__pyx_v_onselect = 0;
  #if !CYTHON_METH_FASTCALL
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_autocomplete_data,&__pyx_mstate_global->__pyx_n_u_onselect,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "autocomplete", 0) < (0)) __PYX_ERR(0, 63, __pyx_L3_error)
      if (!values[1]) values[1] = __Pyx_NewRef(((PyObject *)Py_None));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("autocomplete", 0, 1, 2, i); __PYX_ERR(0, 63, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  2:
    ...
    __pyx_v_autocomplete_data = values[0];
    __pyx_v_onselect = values[1];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("autocomplete", 0, 1, 2, __pyx_nargs); __PYX_ERR(0, 63, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("simplestart.ui.autocomplete.autocomplete", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11simplestart_2ui_12autocomplete_autocomplete(__pyx_self, __pyx_v_autocomplete_data, __pyx_v_onselect);
...
static PyObject *__pyx_pf_11simplestart_2ui_12autocomplete_autocomplete(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_autocomplete_data, PyObject *__pyx_v_onselect) {
  ...
  /* "simplestart/ui/autocomplete.py":74
 *         autocomplete
 *     """
 *     handlers = {"onSelect": onselect} if onselect else {}             # <<<<<<<<<<<<<<
 *     return loadvue(
 *         template=vue_template_basic,
*/
  __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_v_onselect); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 74, __pyx_L1_error)
  if (__pyx_t_2) {
    __pyx_t_3 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_onSelect, __pyx_v_onselect) < (0)) __PYX_ERR(0, 74, __pyx_L1_error)
    __pyx_t_1 = __pyx_t_3;
    __pyx_t_3 = 0;
  } else {
  ...
  /* "simplestart/ui/autocomplete.py":75
 *     """
 *     handlers = {"onSelect": onselect} if onselect else {}
 *     return loadvue(             # <<<<<<<<<<<<<<
 *         template=vue_template_basic,
...
*/
  ...
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_loadvue); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);

  /* "simplestart/ui/autocomplete.py":76
 *     handlers = {"onSelect": onselect} if onselect else {}
 *     return loadvue(
 *         template=vue_template_basic,             # <<<<<<<<<<<<<<
 *         data=autocomplete_data,
 *         handlers=handlers
*/
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_vue_template_basic); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);

  /* "simplestart/ui/autocomplete.py":78
 *         template=vue_template_basic,
 *         data=autocomplete_data,
 *         handlers=handlers             # <<<<<<<<<<<<<<
 *     )
*/
  ...
  #endif
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_template, __pyx_t_5, __pyx_t_7, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 75, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_data, __pyx_v_autocomplete_data, __pyx_t_7, __pyx_callargs+1, 1) < (0)) __PYX_ERR(0, 75, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_handlers, __pyx_v_handlers, __pyx_t_7, __pyx_callargs+1, 2) < (0)) __PYX_ERR(0, 75, __pyx_L1_error)
...
static int __pyx_pymod_exec_autocomplete(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_autocomplete},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_autocomplete(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_autocomplete(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_autocomplete(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'autocomplete' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "autocomplete" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_autocomplete", 0);
  ...
  if (__pyx_module_is_main_simplestart__ui__autocomplete) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "simplestart.ui.autocomplete")) {
      if (unlikely((PyDict_SetItemString(modules, "simplestart.ui.autocomplete", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "simplestart/ui/autocomplete.py":2
 * # coreloadvue
 * from core import loadvue             # <<<<<<<<<<<<<<
 * 
 * # Vue
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_loadvue};
  ...
  /* "simplestart/ui/autocomplete.py":5
 * 
 * # Vue
 * vue_template_basic = '''             # <<<<<<<<<<<<<<
 * <template>
...
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_vue_template_basic, __pyx_mstate_global->__pyx_kp_u_template_div_class_demo_autocom) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_11simplestart_2ui_12autocomplete_1autocomplete, 0, __pyx_mstate_global->__pyx_n_u_autocomplete, NULL, __pyx_mstate_global->__pyx_n_u_simplestart_ui_autocomplete, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_autocomplete, __pyx_t_2) < (0)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "simplestart/ui/autocomplete.py":1
 * # coreloadvue             # <<<<<<<<<<<<<<
 * from core import loadvue
 * 
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init simplestart.ui.autocomplete", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init simplestart.ui.autocomplete");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 11; } index[] = {{1},{1},{30},{1119},{20},{18},{12},{17},{18},{4},{4},{8},{8},{13},{5},{7},{8},{10},{8},{8},{8},{3},{12},{12},{10},{27},{8},{8},{6},{18},{42}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (884 bytes) */
const char* const cstring = "BZh91AY&SY!\313_\266\000\000\300\377\373\326^a\001u\347\342\237\355\007\370\n\277\357\377\352C{\351\344rM\305\273@@\007\340@\000@\002\374\\\260\000@\324\324\005?T\361A\247\250hz\236\240b4\001\220\003@\006\200\006\2004\003\324\003OQ\232\231\265C\200\000\000\000\000\0002\000\000\000\000\000\000\000\003 \001\025?D\32253\t\036\246M\251\246\236\223\324\r\0324\0311\003h@4z\203\021\2104h4\014\206\2150\022H\232e=&Sh\032\005<\205?JmM\205\036\240\320\033P\000\032=OQ\351\000\000\000\000\005U\237\263#\300\030f@~\354\202\016[s\243\267\365@\332\361\216\313,\321u\004Y}\317\327O;v\230\245\322+O\350\007\345\350p\374\237\006l\316p\337\366:\220 \232d\200`H\347\3441\371\236\2274N\331\026\312J]\036\304{\027\240O\320\202\242\226\354\336\2330E\262\302+\230X\036[\363r\03584h\214\003\312*\344\345\225\343qX\004\240_\204VZ\315YK!\274\310%Yp\2241\305\024\330\000\022\230\201\320\327*\351\3534r\n\2104\2410DD\340\024H\252\230\340\264Pt\313c\345,\200m\3650T\264E\";\002\212\302F03\200T d\224\000\311\216(\256c\002:o\t\214\200\036\233\"\273\314\007Os\036RaA\345\231\314A\312\325\302\370\204\322I\2307\307Te\316\220\021H\313\234G\220\220\234D\233CDg9\354\236\321g\201\210\323\304\374[\335\315E\340\236d\313\212G\250N\243\227J\365F\nJ\t\014C\204\337\243\026\366Q\371.\264\333\251\346b\302\017\243|vqG\215\272\247]\raXr2f,\357\253\007\313r\377\016Kyq\271Aa\204K\007\016\326\306\306C\323\236\303\324_\271\016\241\304.\
x\"\360a\351j3\317\273\033\201|\365:95T\332\375W_\276tS\ty/\025\026\250Ts\345R\202\000\337\211\231(\215\271oeH\214\225\023m\334\337\371\372hg\353\363\340\333\207\350\311\323\250\267\361\363\365\343\350\341j\364j\r\313)\277\367\306\242'm\263\034p\257\251\364\"\323\276+\23787FJ*H\246\332=\205\253\213B\027O\322\360\364Pzmy\t\3773\202[z\005\226\354\rh\262\230T(\217+\255B+\0020\371\313$\337\246q\341q\211\020*\002j5\036\372\006\343\267q \304\031J\233a\300)M\334\321\206\nC3R\267\371R1\177!\004J\333\014\t\360INs\334\212\2170\245\303u\240\211\356\333Q""\035J\347C&\2234\245\006l\n\305\226\217\342\343\n\032\335\250^(\274\274\342\341\rB\251E\000\245\256\036L,!\3134\230\021\374\307\236\023o.\3749\272g\337\341\336|\377\340\313\313k\3076\346\267\367\036\350\235\355\037\337\336\177\244\177d{\377\241\336u\327\372\013\313H\365\277";
...
const char* const bytes = ".?simplestart/ui/autocomplete.py\n<template>\n  <div class=\"demo-autocomplete\">\n      <el-autocomplete\n        v-model=\"state1\"\n        :fetch-suggestions=\"querySearch\"\n        clearable\n        class=\"w-50\"\n        placeholder=\"\350\257\267\350\276\223\345\205\245\346\220\234\347\264\242\345\206\205\345\256\271\"\n        @select=\"handleSelect\"\n      />\n  </div>\n</template>\n\n<script>\nmodule.exports = {\n  name: 'AutoCompleteComponent',\n  \n  data() {\n    return {\n      state1: '',\n      items: []\n    }\n  },\n  \n  mounted() {\n    // \344\273\216\345\220\216\347\253\257\350\216\267\345\217\226\351\200\211\351\241\271\345\210\227\350\241\250\n    const data = this.fetchData();\n    if (data && data.items) {\n      this.items = data.items;\n    }\n  },\n  \n  methods: {\n    querySearch(queryString, cb) {\n      const results = queryString\n        ? this.items.filter(this.createFilter(queryString))\n        : this.items;\n      cb(results);\n    },\n    \n    createFilter(queryString) {\n      return (item) => {\n        return item.value.toLowerCase().indexOf(queryString.toLowerCase()) === 0;\n      };\n    },\n    \n    handleSelect(item) {\n      console.log('Selected item:', item);\n      // \345\260\206\344\272\213\344\273\266\350\275\254\345\217\221\345\210\260\346\234\215\345\212\241\345\231\250\347\253\257\n      this.streamsync.forwardData(this, 'onSelect', item);\n    }\n  }\n}\n</script>\n__Pyx_PyDict_NextRefasyncio.coroutinesautocompleteautocomplete_datacline_in_tracebackcoredata__func__handlers_is_coroutineitemsloadvue__main____module____name__onSelectonselectpop__qualname____set_name__setdefaultsimplestart.ui.autocompletetemplate__test__valuesvue_template_basic\320\000$\240A\360\026\000\005\020\210q\220\014\230M\250\036\260q\330\004\013\2107\220!\330\010\021\220\021\330\010\r\210Q\330\010\021\220\021";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_autocomplete_data, __pyx_mstate->__pyx_n_u_onselect, __pyx_mstate->__pyx_n_u_handlers};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_simplestart_ui_autocomplete_py, __pyx_mstate->__pyx_n_u_autocomplete, __pyx_mstate->__pyx_kp_b_iso88591_A_q_M_q_7_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
